...
@pytest.mark.slow
def test_slow_ne_el_regressors_match_across_random_3dof_states(tmp_path):
...
@pytest.mark.slow
def test_slow_base_parameter_reduction_preserves_multiple_random_3dof_observation_matrices():
